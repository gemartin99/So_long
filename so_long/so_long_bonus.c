...
void	init_img(t_list *d)
{
	...
	d->enemy_ = mlx_xpm_file_to_image(d->mlx, "enemy.xpm", &img_w, &img_h);
	d->enemyst = mlx_xpm_file_to_image(d->mlx, "enemy.xpm", &img_w, &img_h);
	d->enemymv = mlx_xpm_file_to_image(d->mlx, "enemymv.xpm", &img_w, &img_h);
}
